...
def process(raw_data):
    ...
    print([list(coords) for coords in set(tuple(coords) for coords in processed_data)])
    print(len([list(coords) for coords in set(tuple(coords) for coords in processed_data)]))
